...
public final class MainActivity extends Activity implements PianoTouchListener {
    ...
    private void initPianoRoll() {
        ...
        final PianoRoll pianoRoll = findViewById(R.id.pianoRoll);
        pianoRoll.setNumColumns(16);
        pianoRoll.setNumRows(12);
        ...
        highlightCell = findViewById(R.id.highLightCell);
     ...
     */
    private void createSynthEvent(SynthInstrument synth, double frequency, int position, int duration) {
